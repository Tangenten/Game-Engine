...
namespace RavUtilities {
	public static class CollisionU {
		...
		public static bool PointAABBCollision(Vector2 pPos, AABB aabb) {
		...
		public static bool AABBAABBCollision(AABB rect1, AABB rect2) {
		...
		public static Vector2 LineIntersection(in Vector2 line1Start, in Vector2 line1End, in Vector2 line2Start, in Vector2 line2End) {
			...
			float YIntercept(float slope, Vector2 p1) {
		...
		public static Vector2? LineSegmentIntersection(in Vector2 line1Start, in Vector2 line1End, in Vector2 line2Start, in Vector2 line2End) {
