...
namespace RavUtilities {
	public static class RandomU {
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static short Get(short min, short max) {
			return r.Value.Get(min, max);
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static float GetBell(float min, float max, float mu = 0, float sigma = 1f) {
			return r.Value.GetBell(min, max, mu, sigma);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static float GetTriangular(float min, float max, float mid) {
			return r.Value.GetTriangular(min, max, mid);
		}
	}
	...
	public class RandomNumberGenerator {
		...
		public float Get(float min, float max) {
			return (float)(this.r.NextDouble() * (max - min)) + min;
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public double Get(double min, double max) {
			return this.r.NextDouble() * (max - min) + min;
		}
		...
		public uint Get(uint min, uint max) {
			return (uint)this.r.Next((int)min, (int)max + 1);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public short Get(short min, short max) {
			return (short)this.r.Next(min, max + 1);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public byte Get(byte min, byte max) {
			return (byte)this.r.Next(min, max + 1);
		}
