...
namespace RavUtilities {
	public static class TweenU {
		...
		public static double Linear(double fromValue, double fromMin, double fromMax, double toMin, double toMax) {
			return Math.Clamp(Linear(toMin, toMax, (fromValue - fromMin) / (fromMax - fromMin)), Math.Min(toMin, toMax), Math.Max(toMin, toMax));
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static float InQuartic(float t) {
			return t * t * t * t;
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static float InQuintic(float t) {
			return t * t * t * t * t;
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static float InExponential(float t) {
			return (float) Math.Pow(2, 10 * (t - 1));
		}
		
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static float OutExponential(float t) {
